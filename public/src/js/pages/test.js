    ...
    viewClass = gpV.extend({
      render: function(){
        ...
        $('.js-test-signup').on('click', function(e){
          ...
          $.ajax({
            type: 'POST',
            url: 'http://localhost:3000/signup', //url
            data: {
              username:   'yermom',
              pw:     'yerdad',
        ...
        $('.js-test-form1-submit').on('click', function(e){
          ...
          $.ajax({
            type: 'POST',
            url: 'http://localhost:3000/form1/submit', //url
            data: {
              cats: 33,
              dog: 'rottweiler'
            }, //data
        ...
        $('.js-test-form2-submit').on('click', function(e){
          ...
          $.ajax({
            type: 'POST',
            url: 'http://localhost:3000form2/submit', //url
            data: {
              cats: 1,
